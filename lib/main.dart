...
class _MyAppState extends State<MyApp> {
  StreamSubscription<AwesomeNotifications>? _actionStreamSubscription;
  ...
  // void listen() {
  //   // You can choose to cancel any existing subscriptions
  //   _actionStreamSubscription?.cancel();
  //
  //   // Assign the stream subscription
  //   _actionStreamSubscription = AwesomeNotifications().actionStream.listen((action) {
  ...
  //       cancelCall(context, "You canceled the call");
  //     }
  //   });
  // }
